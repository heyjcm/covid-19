...
write.csv(deaths_per_million_aggregated, paste("Tables/", Sys.Date(), ".csv", sep = ""))
...
death_per_million_plot <- deaths_per_million_data %>% 
  ggplot(aes(x = date, y = total_deaths, color = Province_State, group = Province_State)) +
